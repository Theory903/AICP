...
class DreamService:
    ...
    def get_all_memories(
        ...
        if memory_type:
            return [m for m in self._memories.values() if m.memory_type == memory_type.value]
    ...
    async def prune(
        ...
        scored_memories = [(m, self.calculate_importance_score(m)) for m in memories_to_process]
