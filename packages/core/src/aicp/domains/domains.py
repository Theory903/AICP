...
class DomainPackRegistry:
    ...
    def get_pack(self, pack_id: str) -> Optional[DomainPack]:
        ...
        return DomainPack(
            ...
            capabilities=[
                ...
                DomainCapability(
                    ...
                    kind="action",
                    input_schema={"type": "object", "properties": {"product_id": {"type": "string"}, "quantity": {"type": "integer"}}},
                ...
                DomainCapability(
                    ...
                    kind="action",
                    input_schema={"type": "object", "properties": {"cart_id": {"type": "string"}, "payment_method": {"type": "string"}}},
        ...
        return DomainPack(
            ...
            capabilities=[
                DomainCapability(
                    ...
                    kind="action",
                    input_schema={"type": "object", "properties": {"environment": {"type": "string"}, "version": {"type": "string"}}},
                ...
                DomainCapability(
                    ...
                    kind="query",
                    input_schema={"type": "object", "properties": {"service": {"type": "string"}, "level": {"type": "string"}}},
