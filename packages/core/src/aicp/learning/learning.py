...
class LearningService:
    ...
    def get_drift_detections(self, drift_type: Optional[DriftType] = None) -> list[DriftDetection]:
        if drift_type:
...
class PolicyLearner:
    ...
    def learn_from_execution(self, capability_name: str, approval_required: bool, was_approved: bool) -> Optional[LearnedPolicy]:
...
class DriftDetector:
    ...
    def detect_drift(self, metric_name: str, current_value: float, threshold_percent: float = 20.0) -> Optional[DriftDetection]:
