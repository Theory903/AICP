...
class SemanticDiscovery:
    ...
    def index_capability(self, name: str, description: str, tags: Optional[list[str]] = None):
...
def create_embedding_provider(provider_type: str, **kwargs) -> Optional[EmbeddingProvider]:
