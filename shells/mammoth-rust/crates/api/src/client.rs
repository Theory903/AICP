...
use crate::providers::openai_compat_provider::{OpenAICompatClient, OpenAIStream};
...
impl ProviderClient {
    ...
    pub fn from_model_with_default_auth(
        ...
        match ProviderRegistry::for_model(&resolved_model)? {
            ...
            AnyProvider::OpenAI(client) => Ok(Self::OpenAI(client)),
        }
    }
    ...
    pub async fn send_message(
        ...
        match self {
            ...
            Self::OpenAI(client) => send_via_provider(client, request).await,
        }
    }
    ...
    pub async fn stream_message(
        ...
        match self {
            ...
            Self::OpenAI(client) => stream_via_provider(client, request)
                .await
                .map(MessageStream::OpenAI),
        }
    }
}
