...
fn resolve_saved_oauth_token_set(
    ...
    let client = MammothApiClient::from_auth(AuthSource::None).with_base_url(read_base_url());
...
impl Provider for MammothApiClient {
...
mod tests {
    ...
    use super::{
        ...
        resolve_startup_auth_source, AuthSource, MammothApiClient, OAuthTokenSet,
    };
    ...
    fn backoff_doubles_until_maximum() {
        let client = MammothApiClient::new("test-key").with_retry_policy(
            3,
