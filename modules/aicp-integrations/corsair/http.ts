/**
 * AICP Integration HTTP - HTTP client utilities for building AICP integration plugin clients
 *
 ...
 * @example
 * ```ts
 * import { request, ApiError } from '@aicp/integration-core/http';
 * import type { ApiRequestOptions, OpenAPIConfig } from '@aicp/integration-core/http';
 * ```
 */
