/**
 * AICP Integration ORM - Type-safe database operations for AICP integrations
 *
 * This module provides ORM functionality with support for:
 ...
 * @example
 * ```ts
 * import { createPluginOrm } from '@aicp/integration-core/orm';
 *
