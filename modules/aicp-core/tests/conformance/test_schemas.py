...
from aicp.capability import PolicyRef
...
SCHEMAS_DIR = Path(__file__).parent.parent.parent.parent.parent / "aicp-core" / "spec" / "schemas"
...
class TestCapabilitySchemaConformance:
    ...
    def test_capability_with_render_and_continuation(self):
        ...
        capability = Capability(
            ...
            continuation=ContinuationSpec(
                can_continue=True, next_capabilities=["payments.receipt"]
            ),
        )
        data = capability.model_dump(exclude_none=True, mode="json")
    ...
    def test_capability_with_policy_ref(self):
        ...
        capability = Capability(
            ...
            description="Transfer funds",
            kind=CapabilityKind.ACTION,
            policy=PolicyRef(policy_name="high_value_confirmation", parameters={}),
        )
        data = capability.model_dump(exclude_none=True, mode="json")
    ...
    def test_capability_with_provider_info(self):
        ...
        capability = Capability(
            ...
            description="Test",
            kind=CapabilityKind.ACTION,
            provider=ProviderInfo(name="my_provider", type="http"),
        )
        data = capability.model_dump(exclude_none=True, mode="json")
...
FIXTURES_DIR = (
    Path(__file__).parent.parent.parent.parent.parent / "aicp-core" / "spec" / "tests"
)
