from aicp.code_intelligence.models import ASTNode, CallEdge, SymbolKind, SymbolLocation
...
def test_symbol_graph_add_and_get():
    ...
    sym2 = ASTNode(
        ...
        name="my_func",
        location=SymbolLocation(uri="file2.py", line=5, character=4),
    )
...
def test_symbol_graph_clear():
    ...
    graph.add_symbol(
        ASTNode(
            ...
            name="x",
            location=SymbolLocation(uri="a.py", line=1, character=0),
        )
    )
