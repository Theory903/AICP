...
class Message:
    ...
    text: str
    timestamp: str
    attachment_transfer_id: str | None = None  # Link to attachment transfer (v0.14.0)
...
class ConversationMonitor:
    ...
    async def on_message(self, message: Message) -> KnowledgeCommitProposal | None:
    ...
    async def generate_commit_proposal(self, force: bool = False) -> KnowledgeCommitProposal | None:
...
"""
    ...
    def should_suggest_extraction(self, threshold: float | None = None) -> bool:
    ...
    def add_message(self, role: str, content: str, attachments: list[dict[str, Any]] | None = None,
                    timestamp: str | None = None, sender_node_id: str | None = None,
                    sender_name: str | None = None, message_id: str | None = None):
    ...
    def get_cached_peer_context(self, node_id: str) -> Any | None:
    ...
    def get_cached_peer_device_context(self, node_id: str) -> dict | None:
