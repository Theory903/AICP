...
from .models import ASTNode, SymbolKind, SymbolLocation
...
class ASTIndexer:
    ...
    def _process_node(self, node: ast.AST, file_path: str, parent_id: str | None = None) -> list[ASTNode]:
        nodes = []
        current_node = None
    ...
    def _get_assign_name(self, node: ast.Assign) -> str | None:
