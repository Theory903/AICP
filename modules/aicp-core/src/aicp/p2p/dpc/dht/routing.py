...
from .distance import NODE_ID_BITS, bucket_index, xor_distance
...
class KBucket:
    ...
    def get_node(self, node_id: str) -> DHTNode | None:
...
class RoutingTable:
    ...
    def get_bucket_for_node(self, node_id: str) -> KBucket | None:
        """
