...
from ..models.peer_endpoint import IPv4Info, IPv6Info, PeerEndpoint, PunchInfo, RelayInfo
...
class DHTManager:
    ...
    async def _ping_node(self, ip: str, port: int) -> dict | None:
        """
    ...
    async def find_peer(self, target_node_id: str) -> tuple[str, int] | None:
        """
    ...
    def _get_global_ipv6(self) -> str | None:
        """
    ...
    async def find_peer_full(self, target_node_id: str) -> PeerEndpoint | None:
        """
