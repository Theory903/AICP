...
class Task:
    ...
    status: str = "pending"
    scheduled_at: str | None = None  # ISO timestamp, None = immediate
...
class TaskQueue:
    ...
    def __init__(self, agent_root: Path):
        ...
        # Callbacks
        self._on_task_start: Callable[[Task], Any] | None = None
        self._on_task_complete: Callable[[Task], Any] | None = None
        self._on_task_failed: Callable[[Task], Any] | None = None
    ...
    def set_callbacks(
        ...
        on_task_complete: Callable[[Task], Any] | None = None,
        on_task_failed: Callable[[Task], Any] | None = None,
    ) -> None:
        """
