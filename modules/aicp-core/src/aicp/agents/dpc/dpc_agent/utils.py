...
def get_agent_root(agent_id: str | None = None) -> pathlib.Path:
    """
...
def ensure_agent_dirs(agent_id: str | None = None) -> None:
    """
...
class AgentRegistry:
    ...
    def unlink_agent_from_telegram(self, agent_id: str) -> dict[str, Any] | None:
        """
    ...
    def get_agent_linked_chat(self, agent_id: str) -> str | None:
        """
...
def run_cmd(cmd: list[str], cwd: pathlib.Path | None = None, timeout: int = 30) -> str:
    """
