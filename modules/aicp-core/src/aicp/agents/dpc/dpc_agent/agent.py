...
from .task_types import BUILTIN_TASK_TYPES, TaskTypeDefinition
from .tools.registry import ToolContext, ToolRegistry
from .utils import append_jsonl, get_agent_root, utc_now_iso
...
class DpcAgent:
    ...
    def __init__(
        ...
        agent_root: pathlib.Path | None = None,
        firewall: Any | None = None,  # ContextFirewall for tool control
        provider_alias: str | None = None,  # Per-agent provider override (Phase 3)
        firewall_profile: str | None = None,  # Per-agent permission profile (Phase 2)
    ):
        """
        ...
        self._evolution: Any | None = None  # EvolutionManager
        self._evolution_enabled = self.config.evolution_enabled

        # Background consciousness (optional)
        self._consciousness: BackgroundConsciousness | None = None
    ...
    def _get_allowed_tools(self) -> set | None:
        """
    ...
    def start_consciousness(self, emit_progress: Callable[[str], None] | None = None) -> None:
        """
    ...
    def get_task_type(self, task_type: str) -> TaskTypeDefinition | None:
        """
