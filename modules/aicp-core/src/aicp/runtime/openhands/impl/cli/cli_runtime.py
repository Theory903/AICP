...
from aicp.core.config import OpenHandsConfig
from aicp.core.config.mcp_config import MCPConfig, MCPStdioServerConfig
from aicp.core.logger import openhands_logger as logger
from aicp.events import EventStream
...
from aicp.integrations.provider import PROVIDER_TOKEN_TYPE
from aicp.llm.llm_registry import LLMRegistry
from aicp.runtime.base import Runtime
from aicp.runtime.plugins import PluginRequirement
from aicp.runtime.runtime_status import RuntimeStatus
...
if sys.platform == 'win32':
    try:
        from aicp.runtime.utils.windows_exceptions import DotNetMissingError
        from aicp.runtime.utils.windows_bash import WindowsPowershellSession  # isort: skip
...
class CLIRuntime(Runtime):
    ...
    def _execute_powershell_command(
        ...
        try:
            ...
            from aicp.events.action import CmdRunAction
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from aicp.mcp.utils import call_tool_mcp as call_tool_mcp_handler
        from aicp.mcp.utils import create_mcp_clients
    ...
    def copy_to(self, host_src: str, sandbox_dest: str, recursive: bool = False):
        ...
        try:
            ...
            # Case 2: Source is a file.
                ...
                if os.path.isdir(dest) or (sandbox_dest.endswith(('/', os.sep))) or not os.path.exists(dest) and '.' not in os.path.basename(dest):
                    target_dir = dest
